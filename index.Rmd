...
Based on our regression results, only linguistic fractionalization appears to be statistically significant. Nevertheless, from a substantive standpoint, its effect on freedom of the press is completely non-significant. Moreover, we run different model specifications (e.g.: without limiting the sample to those countries for which we have data regarding Gini, using organizational freedom as alternative dependent variable, first difference regression for years 2008 and 2010) but all of them yielded non-significant coefficient estimates. 
