...
stargazer::stargazer(M1, M2, M3, dep.var.labels=label_DV, covariate.labels = labels_IVs, title = "Regression Results: Pooled OLS (1), Pooled OLS with interaction (2) and Fixed Effects (3)", digits = 2, type = "latex", header = FALSE)
